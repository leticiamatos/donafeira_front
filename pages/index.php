   ...
   <section class="wrapHighlight">
      <ul class="listCont">
        <li>
          <div class="cont">
            <a href="#">
              <img src="images/temporary/banner01.jpg" alt="Imagem 1"/>
            </a>
          </div>
        </li><!-- block -->
        <li>
          <div class="cont">
            <a href="#">
              <img src="images/temporary/banner02.jpg" alt="Imagem 2"/>
            </a>
          </div>
        </li><!-- block -->
      </ul>
...
<div class="wrap-full bg-white b-bottom-gray pad-bottom pad-top over-hidden">
  <div class="container">
      <div id="main">
        <ul class="list-itens">
